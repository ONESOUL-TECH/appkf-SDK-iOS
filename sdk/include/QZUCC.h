 ...
 * @param bundle 涉及资源的bundle名称，如：Onesoul-IM-SDK-Bundle.bundle
 * @param delete 回调delegate
 * @return
 */
+ (void)initWithAbility:(NSString *)abilityOption bundle:(NSString *)bundle delegate:(id<QZUCCDelegate>)theDelegate;
 ...
 * @return 
 */
- (void)connectWithUCMUrl:(NSString *)ucmUrl appKey:(NSString *)appKey user:(NSString *)user authToken:(NSString *)authToken completion:(void (^)(void))completion fail:(void (^)(NSError *error))fail;
